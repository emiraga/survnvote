...
if(isset($_POST['AUTHOR']))//sometimes the username in the cookie is different with the current username.
{
	if($userName!=$_POST['AUTHOR'])
...
if($titleLength>60)//the wiki tile can not exceed 256 bytes, but to make the page look good. Keep the title under 60 bytes.
{
	$wikiText.="===$title===\n";
