...
require_once("$vgPath/../survnvote.setup.php");
...
if( true ) /* testing Telephone */
{
    ...
    $vgDB->Execute("INSERT INTO {$vgDBPrefix}used_receivers VALUES ('{$phoneprefix}10')");
    $vgDB->Execute("INSERT INTO {$vgDBPrefix}used_receivers VALUES ('{$phoneprefix}19')");
    ...
    $vgDB->Execute("INSERT INTO {$vgDBPrefix}used_receivers VALUES ('{$phoneprefix}05')");
