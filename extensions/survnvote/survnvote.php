...
$wgExtensionMessagesFiles['Survnvote'] = "$vgPath/survnvote.i18n.php";
$wgExtensionAliasesFiles['Survnvote'] = "$vgPath/survnvote.alias.php";
...
//Special page LatestIncoming
$wgAutoloadClasses['SurvnvoteStats'] = "$vgPath/special/SurvnvoteStats.php";
$wgAutoloadClasses['SurvnvoteStatsUpdate'] = "$vgPath/special/SurvnvoteStats.php";
$wgSpecialPages['SurvnvoteStats'] = 'SurvnvoteStats';
...
$wgExtensionCredits['other'][] = array(
        'name' => 'Survnvote.net',
        'author' => 'Emir Habul',
        'url' => 'http://www.survnvote.net/',
        'description' => 'survnvote - Audience Response System',
        'descriptionmsg' => 'survnvote-desc',
        'version' => '0.2.7',
);
