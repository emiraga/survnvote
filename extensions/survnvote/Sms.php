<?php
if (!defined('MEDIAWIKI') ) die(); if (defined('SURVNVOTE_TEST')) return;
/**
 ...
 * to adjust survnvote to your system.
 *
 * @package SmsIntegration
 */
class Sms
{
    ...
    static public $msgConfim = 'Confirmation code is %s. Thank you for using www.survnvote.net.';
     ...
     * 
     * Action which is performed when survnvote wants to send an SMS to certain number
     *
