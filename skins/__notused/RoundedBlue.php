 ...
 class="<?php $this->text('nsclass') ?> <?php $this->text('dir') ?>">
	...
	<div id="content">
	  <a name="top" id="top"></a>
		...
		<div class="post">
	   <div class="postop"><div class="pheadfill"><h1 class="firstHeading"><?php $this->data['displaytitle']!=""?$this->text('title'):$this->html('title') ?></h1></div><!--//pheadfill --></div><!--//postop -->
		<div id="bodyContent">
...
<?php
$sid="538295";
include("/home/jenny_jenny/RoundedBlue.com/analysis/write_logs.php");
?>
</div>
</body></html>
<?php
