 ...
 * @subpackage Skins
 */
class SkinsnapHouston extends SkinTemplate {
	/** Using monobook. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'snaphouston';
		$this->stylename = 'snaphouston';
		$this->template  = 'snapHoustonTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class snapHoustonTemplate extends QuickTemplate {
	/**
 ...
 class="<?php $this->text('nsclass') ?> <?php $this->text('dir') ?>">
	<div id="globalWrapper">
		<div id="myhead">
			...
			?>title="<?php $this->msg('mainpage') ?>"><img src="<?php $this->text('logopath') ?>" alt="<?php $this->msg('mainpage') ?>" /></a>
		</div>
...
<?php		}
		...
		wfRunHooks( 'snapHoustonTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
...
?>
			<ul id="f-list">
			<li id="skin"><a href="http://www.ipbwiki.com/forums/index.php?showtopic=398">Skin by Damian Smith</a></li>
<?php
		$footerlinks = array(
