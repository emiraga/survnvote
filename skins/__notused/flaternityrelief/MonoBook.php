...
/*<![CDATA[*/ @import "<?php $this->text('stylepath') ?>/<?php $this->text('stylename') ?>/main.css"; /*]]>*/
</style>
...
<!-- BEGIN titleBar -->
<div id="titleBar">
  <a href="http://www.fraternalrelief.org/"><img src="/skins/monobook/titlebar_katrina.png" alt="FraternalRelief.org" width="322" height="65" border="0" /></a>
<h1><a href="http://www.fraternalrelief.org/">FraternalRelief.org</a></h1>
<small>Katrina Relief for Fraternal Organizations</small>
</div>
<!-- END titleBar -->
<div id="globalWrapper">
  ...
  <!-- END search -->
    ...
    <!-- END personal tools -->
    <!-- HIDING code that I'm not sure is needed
    <div class="portlet" id="p-logo"> <a style="background-image: url(<?php $this->
    text('logopath') ?>);" href="<?php echo htmlspecialchars($this->data['nav_urls']['mainpage']['href'])?>" title="
    <?php $this->msg('mainpage') ?>
"></a> </div>
  ...
  <div class="portlet" id="p-nav">
    ...
    <div class="pBody">
      <ul>
        ...
        <li id="<?php echo htmlspecialchars($navlink['id'])?>"><a href="<?php echo htmlspecialchars($navlink['href']) ?>">
          <?php 
...
<div id="footer">
  <ul id="f-list">
    ...
    <li id="f-copyright">
      <?php $this->html('copyright')  ?>
    </li>
    <?php } ?>
    <?php if($this->data['about'     ]) { ?>
    <li id="f-about">
      <?php $this->html('about')      ?>
    </li>
    <?php } ?>
    <?php if($this->data['disclaimer']) { ?>
    <li id="f-disclaimer">
      <?php $this->html('disclaimer') ?>
    </li>
    <?php } ?>
  </ul>
</div>
