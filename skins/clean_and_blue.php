 ...
 * @subpackage Skins
 */
class Skinclean_and_blue extends SkinTemplate {
	/** Using clean_and_blue. */
	function initPage( &$out ) {
		SkinTemplate::initPage( $out );
		$this->skinname  = 'clean_and_blue';
		$this->stylename = 'clean_and_blue';
		$this->template  = 'clean_and_blueTemplate';
	}
}
 ...
 * @subpackage Skins
 */
class clean_and_blueTemplate extends QuickTemplate {
	/**
	 * Template filter callback for clean_and_blue skin.
...
<?php		}
		...
		wfRunHooks( 'clean_and_blueTemplateToolboxEnd', array( &$this ) );
?>
			</ul>
		</div>
	</div>
