 ...
 * @ingroup Skins
 */
class SkinWaveLover2 extends SkinTemplate {
	/** Using wavelover2. */
	function initPage( OutputPage $out ) {
		parent::initPage( $out );
		$this->skinname  = 'wavelover2';
		$this->stylename = 'wavelover2';
		$this->template  = 'WaveLover2Template';
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( 'wavelover2/main.css', 'screen' );
		if( $wgHandheldStyle ) {
			// Currently in testing... try 'chick/main.css'
			$out->addStyle( $wgHandheldStyle, 'handheld' );
		}

		$out->addStyle( 'wavelover2/IE50Fixes.css', 'screen', 'lt IE 5.5000' );
 ...
 * @ingroup Skins
 */
class WaveLover2Template extends QuickTemplate {
	var $skin;
	/**
	 * Template filter callback for WaveLover2 skin.
...
<?php		}
		...
		wfRunHooks( 'WaveLover2TemplateToolboxEnd', array( &$this ) );
